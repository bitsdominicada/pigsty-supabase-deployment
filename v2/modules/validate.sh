...
check_var_optional DDL_SUBDOMAIN
echo ""
...
DDL_FQDN="${DDL_SUBDOMAIN:-ddl}.${DOMAIN:-}"
...
echo "  DDL:    https://${DDL_FQDN}"
echo "  API:    https://${API_FQDN}"
echo "  Studio: https://${STUDIO_FQDN}"
echo "  Portal: https://${PORTAL_FQDN}"
echo "  Registry (private):    http://127.0.0.1:5000"
echo "  Registry UI (private): http://127.0.0.1:5080"
echo "----------------------------------------------"
echo ""
