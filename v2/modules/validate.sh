...
POS_FQDN="${POS_SUBDOMAIN:-pos}.${DOMAIN:-}"
AI_FQDN="${AI_SUBDOMAIN:-ai}.${DOMAIN:-}"
PORTAL_FQDN="${PORTAL_SUBDOMAIN:-home}.${DOMAIN:-}"
REGISTRY_FQDN="${REGISTRY_SUBDOMAIN:-registry}.${DOMAIN:-}"
REGISTRY_UI_FQDN="${REGISTRY_UI_SUBDOMAIN:-registry-ui}.${DOMAIN:-}"

echo "----------------------------------------------"
echo "Derived URLs:"
echo "  App:    https://${APP_FQDN}"
echo "  POS:    https://${POS_FQDN}"
echo "  AI:     https://${AI_FQDN}"
echo "  API:    https://${API_FQDN}"
echo "  Studio: https://${STUDIO_FQDN}"
echo "  Portal: https://${PORTAL_FQDN}"
echo "  Registry:    https://${REGISTRY_FQDN}"
echo "  Registry UI: https://${REGISTRY_UI_FQDN}"
echo "----------------------------------------------"
echo ""
